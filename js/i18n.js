...
export const I18N = {
  en: {
    ...
    "chotu.orType": "…or type it here", "chotu.send": "Send",
    "chotu.whoAreYou": "Your name", "chotu.yourName": "e.g. Kausar",
    "chotu.whyName": "Everything you record is saved under your name, so anyone can ask you about it later.",
    "chotu.hello": "Hello {who}", "chotu.check": "Check this before saving",
    "chotu.commit": "Yes, save it", "chotu.saved": "Saved",
    "chotu.dropped": "Dropped — nothing was saved",
    "chotu.missing": "Still needed: {what}", "chotu.nameFirst": "Tell me your name first",
    "chotu.unsure": "I did not catch that. Say it again?",
    "chotu.offline": "I can look things up but I cannot talk right now.",
    "chotu.speaker": "Recorded by", "chotu.action": "What I will do",
  ...
  hi: {
    ...
    "chotu.orType": "…या यहाँ टाइप करें", "chotu.send": "भेजें",
    "chotu.whoAreYou": "आपका नाम", "chotu.yourName": "जैसे कौसर",
    "chotu.whyName": "आप जो भी दर्ज करेंगे वह आपके नाम से सहेजा जाएगा, ताकि बाद में कोई पूछ सके।",
    "chotu.hello": "नमस्ते {who}", "chotu.check": "सहेजने से पहले जाँच लें",
    "chotu.commit": "हाँ, सहेजें", "chotu.saved": "सहेजा गया",
    "chotu.dropped": "रद्द — कुछ नहीं सहेजा गया",
    "chotu.missing": "अभी चाहिए: {what}", "chotu.nameFirst": "पहले अपना नाम बताएं",
    "chotu.unsure": "समझ नहीं आया। फिर से कहें?",
    "chotu.offline": "मैं जानकारी देख सकता हूँ पर अभी बोल नहीं सकता।",
    "chotu.speaker": "दर्ज करने वाला", "chotu.action": "मैं यह करूँगा",
  ...
  bn: {
    ...
    "chotu.orType": "…অথবা এখানে টাইপ করুন", "chotu.send": "পাঠান",
    "chotu.whoAreYou": "আপনার নাম", "chotu.yourName": "যেমন কাউসার",
    "chotu.whyName": "আপনি যা লিখবেন তা আপনার নামে সংরক্ষিত হবে, যাতে পরে কেউ জিজ্ঞেস করতে পারে।",
    "chotu.hello": "নমস্কার {who}", "chotu.check": "সংরক্ষণের আগে দেখে নিন",
    "chotu.commit": "হ্যাঁ, সংরক্ষণ করুন", "chotu.saved": "সংরক্ষিত",
    "chotu.dropped": "বাতিল — কিছুই সংরক্ষণ হয়নি",
    "chotu.missing": "এখনো দরকার: {what}", "chotu.nameFirst": "আগে আপনার নাম বলুন",
    "chotu.unsure": "বুঝতে পারিনি। আবার বলবেন?",
    "chotu.offline": "আমি তথ্য দেখতে পারি কিন্তু এখন কথা বলতে পারছি না।",
    "chotu.speaker": "যিনি লিখেছেন", "chotu.action": "আমি যা করব",
